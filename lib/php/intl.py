...
def IntlRuleBasedBreakIterator():
    DONE = -1
    WORD_NONE = 0
    WORD_NONE_LIMIT = 100
    WORD_NUMBER = 100
...
def IntlCodePointBreakIterator():
    DONE = -1
    WORD_NONE = 0
    WORD_NONE_LIMIT = 100
    WORD_NUMBER = 100
