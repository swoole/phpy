...
class SystemRandom
{
    ...
    {
        $this->_self = \PyCore::import('random')->SystemRandom($x);
    }
    ...
    public function getrandbits($k)
    {
        return $this->_self->getrandbits($k);
    }
    ...
    {
        return $this->_self->seed();
    }

    public function setstate()
    {
        return $this->_self->setstate();
    }
