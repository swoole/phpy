...
class Spinbox
{
    ...
    {
        $this->_self = \PyCore::import('tkinter')->Spinbox($master, $cnf);
    }
  ...
  0 => '_noarg_',
    ...
    {
        return $this->_self->insert($index, $s);
    }

    public function invoke($element)
    {
        return $this->_self->invoke($element);
    }
  ...
  0 => '_noarg_',
    ...
    public function selection_element($element = null)
    {
        return $this->_self->selection_element($element);
    }
