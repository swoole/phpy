...
class Menu
{
    ...
    {
        $this->_self = \PyCore::import('tkinter')->Menu($master, $cnf);
    }

    public function activate($index)
    {
        return $this->_self->activate($index);
    }

    public function add($itemType, $cnf = [])
    {
        return $this->_self->add($itemType, $cnf);
    }

    public function add_cascade($cnf = [])
    {
        return $this->_self->add_cascade($cnf);
    }

    public function add_checkbutton($cnf = [])
    {
        return $this->_self->add_checkbutton($cnf);
    }

    public function add_command($cnf = [])
    {
        return $this->_self->add_command($cnf);
    }

    public function add_radiobutton($cnf = [])
    {
        return $this->_self->add_radiobutton($cnf);
    }

    public function add_separator($cnf = [])
    {
        return $this->_self->add_separator($cnf);
    }
    ...
    public function entrycget($index, $option)
    {
        return $this->_self->entrycget($index, $option);
    }

    public function entryconfig($index, $cnf = null)
    {
        return $this->_self->entryconfig($index, $cnf);
    }

    public function entryconfigure($index, $cnf = null)
    {
        return $this->_self->entryconfigure($index, $cnf);
    }
  ...
  0 => '_noarg_',
    ...
    public function insert($index, $itemType, $cnf = [])
    {
        return $this->_self->insert($index, $itemType, $cnf);
    }

    public function insert_cascade($index, $cnf = [])
    {
        return $this->_self->insert_cascade($index, $cnf);
    }

    public function insert_checkbutton($index, $cnf = [])
    {
        return $this->_self->insert_checkbutton($index, $cnf);
    }

    public function insert_command($index, $cnf = [])
    {
        return $this->_self->insert_command($index, $cnf);
    }

    public function insert_radiobutton($index, $cnf = [])
    {
        return $this->_self->insert_radiobutton($index, $cnf);
    }

    public function insert_separator($index, $cnf = [])
    {
        return $this->_self->insert_separator($index, $cnf);
    }

    public function invoke($index)
    {
        return $this->_self->invoke($index);
    }
  ...
  0 => '_noarg_',
    ...
    public function tk_popup($x, $y, $entry = "")
    {
        return $this->_self->tk_popup($x, $y, $entry);
    }
    ...
    public function type($index)
    {
        return $this->_self->type($index);
    }
    ...
    public function xposition($index)
    {
        return $this->_self->xposition($index);
    }

    public function yposition($index)
    {
        return $this->_self->yposition($index);
    }
