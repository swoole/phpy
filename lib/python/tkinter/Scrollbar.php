...
class Scrollbar
{
    ...
    {
        $this->_self = \PyCore::import('tkinter')->Scrollbar($master, $cnf);
    }

    public function activate($index = null)
    {
    ...
    public function delta($deltax, $deltay)
    {
        return $this->_self->delta($deltax, $deltay);
    }
    ...
    public function fraction($x, $y)
    {
        return $this->_self->fraction($x, $y);
    }
  ...
  0 => '_noarg_',
    ...
    public function set($first, $last)
    {
        return $this->_self->set($first, $last);
    }
