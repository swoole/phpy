...
class Canvas
{
    ...
    {
        $this->_self = \PyCore::import('tkinter')->Canvas($master, $cnf);
    }

    public function addtag()
    {
        return $this->_self->addtag();
    }

    public function addtag_above($newtag, $tagOrId)
    {
        return $this->_self->addtag_above($newtag, $tagOrId);
    }

    public function addtag_all($newtag)
    {
        return $this->_self->addtag_all($newtag);
    }

    public function addtag_below($newtag, $tagOrId)
    {
        return $this->_self->addtag_below($newtag, $tagOrId);
    }

    public function addtag_closest($newtag, $x, $y, $halo = null, $start = null)
    {
        return $this->_self->addtag_closest($newtag, $x, $y, $halo, $start);
    }

    public function addtag_enclosed($newtag, $x1, $y1, $x2, $y2)
    {
        return $this->_self->addtag_enclosed($newtag, $x1, $y1, $x2, $y2);
    }

    public function addtag_overlapping($newtag, $x1, $y1, $x2, $y2)
    {
        return $this->_self->addtag_overlapping($newtag, $x1, $y1, $x2, $y2);
    }

    public function addtag_withtag($newtag, $tagOrId)
    {
        return $this->_self->addtag_withtag($newtag, $tagOrId);
    }
    ...
    public function canvasx($screenx, $gridspacing = null)
    {
        return $this->_self->canvasx($screenx, $gridspacing);
    }

    public function canvasy($screeny, $gridspacing = null)
    {
        return $this->_self->canvasy($screeny, $gridspacing);
    }
    ...
    {
        return $this->_self->coords();
    }

    public function create_arc()
    {
        return $this->_self->create_arc();
    }

    public function create_bitmap()
    {
        return $this->_self->create_bitmap();
    }

    public function create_image()
    {
        return $this->_self->create_image();
    }

    public function create_line()
    {
        return $this->_self->create_line();
    }

    public function create_oval()
    {
        return $this->_self->create_oval();
    }

    public function create_polygon()
    {
        return $this->_self->create_polygon();
    }

    public function create_rectangle()
    {
        return $this->_self->create_rectangle();
    }

    public function create_text()
    {
        return $this->_self->create_text();
    }

    public function create_window()
    {
        return $this->_self->create_window();
    }

    public function dchars()
    {
        return $this->_self->dchars();
    }

    public function delete()
    {
        return $this->_self->delete();
    }
    ...
    {
        return $this->_self->find();
    }

    public function find_above($tagOrId)
    {
        return $this->_self->find_above($tagOrId);
    }

    public function find_all()
    {
        return $this->_self->find_all();
    }

    public function find_below($tagOrId)
    {
        return $this->_self->find_below($tagOrId);
    }

    public function find_closest($x, $y, $halo = null, $start = null)
    {
        return $this->_self->find_closest($x, $y, $halo, $start);
    }

    public function find_enclosed($x1, $y1, $x2, $y2)
    {
        return $this->_self->find_enclosed($x1, $y1, $x2, $y2);
    }

    public function find_overlapping($x1, $y1, $x2, $y2)
    {
        return $this->_self->find_overlapping($x1, $y1, $x2, $y2);
    }

    public function find_withtag($tagOrId)
    {
        return $this->_self->find_withtag($tagOrId);
    }
  ...
  0 => '_noarg_',
    ...
    public function icursor()
    {
        return $this->_self->icursor();
    }
    ...
    {
        return $this->_self->insert();
    }

    public function itemcget($tagOrId, $option)
    {
        return $this->_self->itemcget($tagOrId, $option);
    }

    public function itemconfig($tagOrId, $cnf = null)
    {
        return $this->_self->itemconfig($tagOrId, $cnf);
    }

    public function itemconfigure($tagOrId, $cnf = null)
    {
        return $this->_self->itemconfigure($tagOrId, $cnf);
    }
    ...
    {
        return $this->_self->move();
    }

    public function moveto($tagOrId, $x = "", $y = "")
    {
        return $this->_self->moveto($tagOrId, $x, $y);
    }
  ...
  0 => '_noarg_',
    ...
    public function postscript($cnf = [])
    {
        return $this->_self->postscript($cnf);
    }
  ...
  0 => '_noarg_',
    ...
    {
        return $this->_self->scale();
    }

    public function scan_dragto($x, $y, $gain = 10)
    {
        return $this->_self->scan_dragto($x, $y, $gain);
    }
    ...
    public function select_adjust($tagOrId, $index)
    {
        return $this->_self->select_adjust($tagOrId, $index);
    }

    public function select_clear()
    {
        return $this->_self->select_clear();
    }

    public function select_from($tagOrId, $index)
    {
        return $this->_self->select_from($tagOrId, $index);
    }

    public function select_item()
    {
        return $this->_self->select_item();
    }

    public function select_to($tagOrId, $index)
    {
        return $this->_self->select_to($tagOrId, $index);
    }
    ...
    public function tag_bind($tagOrId, $sequence = null, $func = null, $add = null)
    {
        return $this->_self->tag_bind($tagOrId, $sequence, $func, $add);
    }

    public function tag_lower()
    {
        return $this->_self->tag_lower();
    }

    public function tag_raise()
    {
        return $this->_self->tag_raise();
    }

    public function tag_unbind($tagOrId, $sequence, $funcid = null)
    {
        return $this->_self->tag_unbind($tagOrId, $sequence, $funcid);
    }
    ...
    public function tkraise()
    {
        return $this->_self->tkraise();
    }

    public function type($tagOrId)
    {
        return $this->_self->type($tagOrId);
    }
