...
class Listbox
{
    ...
    {
        $this->_self = \PyCore::import('tkinter')->Listbox($master, $cnf);
    }
    ...
    public function curselection()
    {
        return $this->_self->curselection();
    }

    public function delete($first, $last = null)
    {
        return $this->_self->delete($first, $last);
    }
    ...
    public function get($first, $last = null)
    {
        return $this->_self->get($first, $last);
    }
  ...
  0 => '_noarg_',
    ...
    {
        return $this->_self->insert($index);
    }

    public function itemcget($index, $option)
    {
        return $this->_self->itemcget($index, $option);
    }

    public function itemconfig($index, $cnf = null)
    {
        return $this->_self->itemconfig($index, $cnf);
    }

    public function itemconfigure($index, $cnf = null)
    {
        return $this->_self->itemconfigure($index, $cnf);
    }
    ...
    public function nearest($y)
    {
        return $this->_self->nearest($y);
    }
  ...
  0 => '_noarg_',
    ...
    public function select_anchor($index)
    {
        return $this->_self->select_anchor($index);
    }

    public function select_clear($first, $last = null)
    {
        return $this->_self->select_clear($first, $last);
    }

    public function select_includes($index)
    {
        return $this->_self->select_includes($index);
    }

    public function select_set($first, $last = null)
    {
        return $this->_self->select_set($first, $last);
    }

    public function selection_anchor($index)
    {
        return $this->_self->selection_anchor($index);
    }

    public function selection_clear($first, $last = null)
    {
        return $this->_self->selection_clear($first, $last);
    }
    ...
    public function selection_includes($index)
    {
        return $this->_self->selection_includes($index);
    }
    ...
    public function selection_set($first, $last = null)
    {
        return $this->_self->selection_set($first, $last);
    }
