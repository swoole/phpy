...
class Entry
{
    ...
    {
        $this->_self = \PyCore::import('tkinter')->Entry($master, $cnf);
    }
  ...
  0 => '_noarg_',
    ...
    public function icursor($index)
    {
        return $this->_self->icursor($index);
    }
    ...
    {
        return $this->_self->insert($index, $string);
    }
  ...
  0 => '_noarg_',
    ...
    public function scan_dragto($x)
    {
        return $this->_self->scan_dragto($x);
    }

    public function scan_mark($x)
    {
        return $this->_self->scan_mark($x);
    }

    public function select_adjust($index)
    {
        return $this->_self->select_adjust($index);
    }
    ...
    public function select_from($index)
    {
        return $this->_self->select_from($index);
    }

    public function select_present()
    {
        return $this->_self->select_present();
    }

    public function select_range($start, $end)
    {
        return $this->_self->select_range($start, $end);
    }

    public function select_to($index)
    {
        return $this->_self->select_to($index);
    }

    public function selection_adjust($index)
    {
        return $this->_self->selection_adjust($index);
    }
    ...
    public function selection_from($index)
    {
        return $this->_self->selection_from($index);
    }
    ...
    public function selection_present()
    {
        return $this->_self->selection_present();
    }

    public function selection_range($start, $end)
    {
        return $this->_self->selection_range($start, $end);
    }

    public function selection_to($index)
    {
        return $this->_self->selection_to($index);
    }
